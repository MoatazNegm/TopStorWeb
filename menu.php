	...
	<div class=" col-sm-1 leftPane">
		<ul class="nav nav-pills nav-stacked config_leftPane_No_border_textcolor" >
			...
			<li <?php if($men==5) {echo 'class="active"';} ?>><a href="Pools.php"  ><br>Pools</a></li>
			<li <?php if($men==6){echo 'class="active"';} ?>><a href="config.php"  ><br>config</a></li>
			<?php if($men==6){echo '<li ><a href="#"  ><br>colorizePane</a></li>';} ?>
		</ul>
	</div>
