        ...
        <div class="col-md-1 main-menu">
            <ul class="nav flex-column" role="tablist">
                ...
                <li class="nav-item status">
                    <a class="nav-link ref active" data-toggle="tab" href="#" id="arstatus" role="tab">
                        <div></div>
                        الحالة</a>
                </li>
                    ...
                    <form class="dr-form">
                        <div class="form-group row">
                            ...
                            <div class="col-3 logs-check">
                                ...
                                <div class="form-check form-check-inline ">
                                    <label class="form-check-label">
                                        <input id="Warning" class="form-check-input msgtype" type="checkbox" value="option2" checked>تحذيرات
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <label class="form-check-label">
